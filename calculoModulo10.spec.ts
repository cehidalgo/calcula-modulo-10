...
describe('Método calculoModulo10', () => {
  ...
  it('Calcula o módulo 10 da string nula, deve dar erro.', () => {
    expect(() => calculoModulo10(null)).toThrow('Tamanho insuficiente para cálculo do digito verificador.');
    expect(() => calculoModulo10(undefined)).toThrow('Tamanho insuficiente para cálculo do digito verificador.');
    expect(() => calculoModulo10('')).toThrow('Tamanho insuficiente para cálculo do digito verificador.');
  });
});
